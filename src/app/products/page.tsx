  ...
  return (
    <Shell>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
            Manage your inventory, search items, and modify catalog details.
          </p>
        </div>
      ...
      <div className="space-y-3 mb-6">
        ...
        {/* Explain Category + Search Behavior notice */}
        {isBothSearchAndCategory && (
          <div className="flex items-center gap-2 p-3 text-xs bg-indigo-50/70 dark:bg-indigo-950/40 text-indigo-800 dark:text-indigo-300 rounded-xl border border-indigo-100 dark:border-indigo-900/60">
      ...
      {error ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800">
          <Spinner size="lg" />
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6">
